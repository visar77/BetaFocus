...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_3.addWidget(self.top_label, 0, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit, 2, 1, 1, 1, Qt.AlignHCenter | Qt.AlignVCenter)
        ...
        self.gridLayout.addWidget(self.label_r1, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_r2, 1, 1, 1, 1)
        ...
        self.archiv_button.setMaximumSize(QSize(300, 100))
        font2 = QFont()
        ...
        self.gridLayout_3.addWidget(self.archiv_button, 2, 0, 1, 2, Qt.AlignHCenter | Qt.AlignVCenter)
